...
> Entry point for any Codex session in this repo. Global conventions live in `~/.Codex/AGENTS.md`.
...
## The plan
Full plan with diagrams, dashboard mockups, and the demo script: **`docs/plan.html`** (open in a browser). Decision record: `~/Documents/jj-knowledge-vault/agents/Codex-m4/decisions/2026-06-04-notion-personal-products.md`.

## How to build
1. `/memory-loader` (session start, mandatory).
2. `/planning-pipeline` (office-hours → CEO → eng → design → success-criteria) **before any code**.
3. Build with Codex on a `feat/` branch; Codex + context-free review gate per change.
